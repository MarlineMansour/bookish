...
<div id="books" >
    <div class="row m-3 justify-content-center" >
        ...
        <div class="card card-bg-color col-md-2 m-2  align-items-center text-center" data-id="{{$historyBook->category->code}}{{$historyBook->id}}" >
            <img src="{{$historyBook->image}}" class="card-img-top" width="40vh">
            <div class="card-body">
                <h4>{{$historyBook->title}}</h4>
                <p>{{$historyBook->description}}</p>
                <span class="price">
