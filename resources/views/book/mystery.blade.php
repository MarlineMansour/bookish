...
<div id="books" >
    <div class="row m-3 justify-content-center" >
        ...
        <div class="card card-bg-color col-md-2 m-2  align-items-center text-center" data-id="{{$mysteryBook->category->code}}{{$mysteryBook->id}}" >
            <img src="{{$mysteryBook->image}}" class="card-img-top" width="40vh">
            <div class="card-body">
                <h4>{{$mysteryBook->title}}</h4>
                <p>{{$mysteryBook->description}}</p>
                <span class="price">
