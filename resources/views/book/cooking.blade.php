...
<div id="books" >
    <div class="row m-3 justify-content-center" >
        @foreach($cookingBooks as $cookingBook)
        <div class="card card-bg-color col-md-2 m-2  align-items-center text-center" data-id="{{$cookingBook->category->code}}{{$cookingBook->id}}" >
            <img src="{{$cookingBook->image}}" class="card-img-top" width="40vh">
            <div class="card-body">
                <h4>{{$cookingBook->title}}</h4>
                <p>{{$cookingBook->description}}</p>
                <span class="price">
